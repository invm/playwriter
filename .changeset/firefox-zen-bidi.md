...
While automation is on, playwriter installs a toolbar extension in Zen or Firefox. Click it on a tab to connect or disconnect that tab, see relay and session status, or restart the browser with or without automation. Sessions only see connected tabs and tabs they opened. Disconnecting the last tab offers a normal restart.
